  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:w-1/2">
        <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#fde3a7] mb-8 uppercase tracking-wide font-helvetica leading-tight">
          About Me
        </h2>

        <div className=" text-white text-base sm:text-md md:text-lg lg:text-xl leading-relaxed mb-12 font-medium font-abel space-y-5 text-justify max-w-3xl">
          <p>
