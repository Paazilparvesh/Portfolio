...
const EducationSection = () => {
  ...
  return (
    <section
      id="education"
      ref={sectionRef}
      className="relative opacity-0 flex justify-center items-center mb-44 md:mb-0 bg-[#FFB91A] bg-cover bg-center py-20 px-6 md:px-20"
    >
      {/* Main Content */}
      <div className="relative z-10 max-w-7xl mx-auto">
        {/* 🔘 Tabs & Resume */}
        <div className="space-grotesk flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-14">
          {/* Tabs */}
          <ToggleSwitch
          ...
          <a
            href={resume}
            download
            className="bg-[#a95847] text-white px-6 py-3 rounded-full hover:bg-[#fde3a7] hover:text-black text-md md:text-lg lg:text-xl transition font-medium shadow-lg hover:shadow-[#fde3a7]/30 space-grotesk"
          >
            Download Resume
          </a>
        </div>
            ...
            {activeSlide.items.map((item, i) => (
              ...
              >
                ...
                <div className="w-full lg:w-1/5">
                  <p className="text-black group-hover:text-[#a95847] text-base sm:text-lg lg:text-xl font-medium group-hover:scale-105 transition-all duration-300">
                    {item.year}
                  </p>
                </div>
                ...
                <div className="w-full lg:w-2/5">
                  <h3 className="text-black text-md md:text-lg lg:text-xl font-semibold mb-1 uppercase group-hover:text-[#a95847] group-hover:scale-105 transition-transform duration-300 space-grotesk">
                    {item.role}
                  </h3>
                  <p className="text-black group-hover:text-black text-sm md:text-lg font-light group-hover:tracking-wide group-hover:opacity-90 transition-all duration-300">
                    {item.company}
                  </p>
                </div>
                ...
                {/* Description */}
                <div className="w-full lg:w-2/5">
                  <p className="text-black group-hover:text-[#a95847] font-nunito text-sm sm:text-md lg:text-xl leading-relaxed">
                    {item.desc}
                  </p>
                </div>
              </div>
