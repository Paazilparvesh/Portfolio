...
//       {/* Header */}
//       <h1 className="text-4xl md:text-6xl lg:text-8xl 2xl:text-[350px] mt-10 font-bold font-abel mb-16 text-center">
//         Contact Me
//       </h1>
...
//         {/* Contact Info */}
//         <div className="space-y-6 text-sm md:text-base flex flex-col justify-center">
//           <a
...
//           </a>
//           {/* Phone Numbers */}
//           <div className="flex flex-col text-lg md:text-xl space-y-5 ">
//             <a
...
//           <button
//             type="submit"
//             className="bg-white text-black px-6 py-2 font-semibold hover:bg-gray-300 transition"
//           >
//             SUBMIT
//           </button>
...
const ContactPage = () => {
  ...
  return (
    <section className="min-h-screen w-full bg-black text-white px-6 md:px-20 py-20 font-['Helvetica']">
      {/* Header */}
      <h1 className="text-4xl md:text-6xl lg:text-8xl 2xl:text-[160px] mt-20 font-bold font-abel mb-16 text-center">
        Contact Me
      </h1>
